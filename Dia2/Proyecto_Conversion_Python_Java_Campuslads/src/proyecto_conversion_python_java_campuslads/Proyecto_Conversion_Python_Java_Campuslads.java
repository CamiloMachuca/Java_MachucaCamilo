...
public class Proyecto_Conversion_Python_Java_Campuslads {
    ...
    public static void main(String[] args) {
        ...
        while (buclePrincipal==true){
            ...
            System.out.println("(4) Entradas de campers");
            ...
            switch(opcion){
                ...
                case 2:
                    ...
                    if (opcionTrainer==1){
                        System.out.println("Ingrese ti id: ");
                        ...
                        int opcionReportes=teclado.nextInt();
                ...
                case 3:
                    ...
                    while (bucleCoordinador==true){
                        ...
                        int opcionCoordinador=teclado.nextInt();
                ...
                case 4:
                    System.out.println("Entradas de campers");
